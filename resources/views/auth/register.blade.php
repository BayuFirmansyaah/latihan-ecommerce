        ...
        <div class="row g-0">
            ...
            <div class="col-md-4">
                <div id="content-login">
                    ...
                    <p class="deskripsi">Silahkan mendaftar untuk masuk kedalam sistem</p>
                    ...
                    <form action="">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="password" class="form-control" id="password" placeholder="Masukan Konfirmasi Kata Sandi">
                      </div>
